                            ...
                            <div class="card-body">
                                    ...
                                    <form action="{{ url('dosen') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>NIDN</label>
                                            <input type="text" name="Nnidn" class="form-control" autofocus required>
                                        </div>
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input type='text' name="Nnama" class="form-control" autofocus required></input>
                                        </div>
                                        <div class="form-group">
                                            <label>Pendidikan</label>
                                            <input type='text' name="Npendidikan" class="form-control" autofocus required></input>
                                        </div>
                                        <div class="form-group">
                                            <label>Makul</label>
                                            <input type='text' name="Nmakul" class="form-control" autofocus required></input>
                                        </div>
                                        <div class="form-group">
                                            <label>Status</label>
                                            <input type='text' name="Nstatus" class="form-control" autofocus required></input>
                                        </div>
                                        <br>
