                                    ...
                                    @foreach ($mahasiswa as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('mahasiswa/edit') }}" class="btn btn-outline-primary">Edit</a>
                                                <form action="{{ url('mahasiswa/') }}" method="post" class='d-inline' onsubmit="return confirm('Yakin hapus data?')">
                                                            @method('delete')
                                                            @csrf
