                                ...
                                <div class="row">
                                    <form action="{{ url('mahasiswa') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>NIM</label>
                                            <input type="text" name="Nnim" class="form-control" autofocus required>
                                        </div>
                                        <div class="form-group">
                                            <label>Nama</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type='text' name="Nsemester" class="form-control" autofocus required></input>
                                        </div>
                                        <div class="form-group">
                                            <label>Prodi</label>
                                            <input type='text' name="Nprodi" class="form-control" autofocus required></input>
                                        </div>
                                        <div class="form-group">
                                            <label>Fakultas</label>
                                            <input type='text' name="Nfakultas" class="form-control" autofocus required></input>
                                        </div>
                                        <br>
