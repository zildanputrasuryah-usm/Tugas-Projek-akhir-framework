                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="pull-right" >
                                    <a href="{{ url('makul/add') }}" class="btn btn-success btn-sm">
                                    ...
                                    @foreach ($makul as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('makul/edit') }}" class="btn btn-outline-primary">Edit</a>
                                                <form action="{{ url('makul/') }}" method="post" class='d-inline' onsubmit="return confirm('Yakin hapus data?')">
                                                            @method('delete')
                                                            @csrf
